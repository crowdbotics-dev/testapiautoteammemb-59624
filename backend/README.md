...
## Project Structure
    ...
    ├── testapiautoteammemb_59624  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_59624`
...
2. Clone this repo and `cd testapiautoteammemb_59624`
